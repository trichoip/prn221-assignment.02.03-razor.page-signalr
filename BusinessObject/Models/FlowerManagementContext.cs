...
{
    public partial class FlowerManagementContext : DbContext
    {
        public FlowerManagementContext()
        {
        }

        public FlowerManagementContext(DbContextOptions<FlowerManagementContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.FlowerBouquetId })
                    .HasName("PK__OrderDet__C983CA9F92C9BB43");
